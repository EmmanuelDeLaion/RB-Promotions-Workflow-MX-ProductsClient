...
Get-PnPProvisioningTemplate -Out $templatePath -IncludeAllClientSidePages -Force -Handlers "Lists", "Pages" -ListsToExtract "Aprobadores", "Canales", "Categorías", "Categorías de producto", "Clientes", "Configuración", "Marcas", "NotificationTemplates", "Productos", "Productos por cliente", "Promo items", "Promociones", "Subcanales", "SYS_PermissionChangeRequests", "Tipos", "Unidades de negocio", "Volúmenes del último año", "Workflow log"
