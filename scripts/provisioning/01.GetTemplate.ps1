...
Get-PnPProvisioningTemplate -Out template.xml -Handlers Lists -ListsToExtract "Canales", "Categorías", "Clientes", "Promo items", "Promociones", "Subcanales", "Tipos", "Productos"
